...
import com.e2m.TestCases.E2MTestCaes;
...
public class GetScreenShot implements ITestListener {
	...
	public void captureScreenShot(ITestResult result, String status) {
		...
		File scrFile = ((TakesScreenshot) E2MTestCaes.driver).getScreenshotAs(OutputType.FILE);
		...
		try {
			...
			// Reporter.log("<td><a href='" + path + ".png'><img src='" + path +
			// ".png'/></a></td>");
